...
namespace MathForGames
{
    class Game
    {
        ...
        public void Start()
        {
            ...
            Enemy enemyHigh = new Enemy(0, 5, Color.GREEN, new Vector2(0,5), new Vector2(30, 5), 'X', ConsoleColor.Green);
            Enemy enemyMid = new Enemy(25, 10, Color.GREEN, new Vector2(0, 10), new Vector2(30, 10), 'X', ConsoleColor.Green);
            Enemy enemyLow = new Enemy(3, 15, Color.GREEN, new Vector2(0, 15), new Vector2(30, 15), 'X', ConsoleColor.Green);
            Player player = new Player(0, 1, Color.BLUE, '@', ConsoleColor.Red);
            Goal goal = new Goal(10, 20, Color.GREEN, player, 'G', ConsoleColor.Green);
